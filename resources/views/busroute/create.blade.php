    ...
    <main class="w-auto h-screen p-32 flex justify-center items-center">
        <section>
            <div
                ...
                <form method="POST" action="{{ route('admin.busroute.store') }}"
                    ...
                    <div>
                        ...
                        <input id="name" class="mb-3 font-normal text-gray-700 dark:text-gray-400 block mt-1 rounded-md" type="text" name="name" required>
                    </div>
                    <div>
                        <label for="link" class="font-normal text-gray-700 dark:text-gray-400">Ссылка на таблицу</label>
                        <input id="link" class="font-normal text-gray-700 dark:text-gray-400 block mt-1 rounded-md" type="text" name="link" required>
                    </div>
                    <div>
                        <label for="password" class="font-normal text-gray-700 dark:text-gray-400">Начало смены:</label>
                        <input id="password" class="font-normal text-gray-700 dark:text-gray-400 block mt-1 rounded-md w-full" type="time" name="start_time"
                            required>
                    </div>
                    <div>
                        <label for="password" class="font-normal text-gray-700 dark:text-gray-400">Окончание смены:</label>
                        <input id="password" class="font-normal text-gray-700 dark:text-gray-400 block mt-1 rounded-md w-full" type="time" name="end_time"
                            required>
                    </div>
